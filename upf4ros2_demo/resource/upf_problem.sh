...
ros2 service call /upf4ros2/new_problem upf_msgs/srv/NewProblem "{problem_name: test}"

# Create the fluent robot_at

ros2 service call /upf4ros2/add_fluent upf_msgs/srv/AddFluent "{problem_name: test, fluent:{name: robot_at, value_type: up:bool, parameters:[{name: l1, type: Location}]}, default_value:{expressions:[{atom:[{symbol_atom:[], int_atom:[], real_atom:[], boolean_atom:[False]}], type: up:bool, kind: 1}], level:[0]}}"

# Create the objects l1 and l2 (Location)

ros2 service call /upf4ros2/add_object upf_msgs/srv/AddObject "{problem_name: test, object:{name: l1, type: Location}}"

ros2 service call /upf4ros2/add_object upf_msgs/srv/AddObject "{problem_name: test, object:{name: l2, type: Location}}"
