...
class ROS2InterfaceReader(Converter):
    """
    ProtobufReader: This class uses the convert method to take the ROS 2 Interfaces representation of a
...
# 
    ...
    def _convert_action_instance(
        self, msg: ActionInstance, problem: Problem
    ) -> Union[
        Tuple[
            model.timing.Timing,
