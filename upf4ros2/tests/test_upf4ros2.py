...
from upf_msgs.srv import AddFluent, SetInitialValue, AddGoal, AddAction, AddObject
...
from upf_msgs.srv import NewProblem, SetProblem, GetProblem
...
class TestUPF4ROS2(unittest.TestCase):
    ...
    def test_new_problem(self):
        ...
        self.assertEqual(
            response.message,
            'Problem problem_test_1 already exists')
